...
bot_deck = [Creature(7, 'Templar Knight', 5, 5, "Guard", 3323),
            ...
            # Spell(6, "Bodyguards", "Summon  2 Guards from you deck", 786781),
            # Spell(6, "Bodyguards", "Summon  2 Guards from you deck", 67861),
...
demo_deck = [Spell(1, "Bodyguards", "Summon  2 Guards from you deck", 1),
             Spell(1, "Bodyguards", "Summon  2 Guards from you deck", 3),
             Spell(1, "Bodyguards", "Summon  2 Guards from you deck", 2),
             Spell(1, "Bodyguards", "Summon  2 Guards from you deck", 4),
             Spell(1, "Bodyguards", "Summon  2 Guards from you deck", 5),
...
cards_that_are_in_the_game = [Creature(1, "Peasant", 1, 1, "", -1),
                              ...
                              Spell(6, "Bodyguards", "Summon  2 Guards from you deck", -22),
...
knights_orders = [Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 251),
                  ...
                  Spell(6, "Bodyguards", "Summon  2 Guards from you deck", 285),
                  Spell(6, "Bodyguards", "Summon  2 Guards from you deck", 286),
                  ]
