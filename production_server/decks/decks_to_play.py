...
demo_deck = [
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 1),
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 2),
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 3),
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 4),
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 5),
    Creature(1, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 6),
]
