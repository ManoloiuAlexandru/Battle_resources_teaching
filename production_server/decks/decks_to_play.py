...
bot_deck = [
    ...
    #          "building", 11999990),
    # Creature(0, "Wondering Scribe", 4, 4, "When you cast a spell draw a card",
    #          "worker", 11999991),
    # Creature(0, "Armored Peasant", 2, 1, "Armored Guard", "soldier", 11999992),
    # Creature(0, "Rich Peasant", 1, 2,
    #          "Summon 2 armored Peasant with guard and armored", "worker", 11999993),
    # Creature(0, "War elephant", 5, 4,
    #          "While this is on the field your creatures have +1 attack", "animal",
    #          11999994),
    # Creature(0, "Army Champion", 4, 4,
...
demo_deck = [
    Creature(0, "Carcassonne", 8, 8,
             "Can't attack. Deal 8 damage to a random enemy at the end of your turn",
             "building", 7),
    Creature(0, "Joan of Arc", 2, 2,
             "Desperate Summ 7/8 Saint Joan of Arc with charge and armored",
             "worker",
             8),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 0),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 1),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 2),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 3),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 4),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 5),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 6),
]
...
cards_for_byzantine_empire = [
    ...
    Spell(1, "Roman Formation Phalanx", "Give your minions +1/+1", -71),
    Creature(8, "Basil II", 6, 5, "Armored Charge Guard", "soldier", -76),
    Creature(6, "Protokentarchos", 4, 4, "Give a friendly minion +3/+3", "soldier", -77),
    Spell(2, "Old Tactics", "Draw a card and reduce it is cost by 3", -79),
    Creature(2, "Lost Shield", 2, 0, " Guard Desperate Draw a guard", "item", -82),
...
defenders = [Creature(5, "Bishop", 2, 2, "Give a friendly minion +4/+4 and guard", "worker", 100),
             ...
             Creature(6, "Protokentarchos", 4, 4, "Give a friendly minion +3/+3", "soldier", 127),
             Creature(5, "Front Line Defender", 6, 3,
             ...
             Spell(1, "Roman Formation Phalanx", "Give your minions +1/+1", 130),
             ]
...
all_cards_in_game = [Creature(0, "Peasant", 1, 1, "", "worker", -1),
                     ...
                     Creature(2, "Lost Shield", 2, 0, " Guard Desperate Draw a guard", "itme", -82),
                     Spell(2, "Pilum Throw", "Deal 3 damage", -83),
                     Spell(3, "Fast Conscription", "Summon 4 1/1 Peasant", -84),
                     Creature(4, "Lost Noble", 1, 1, "Desperate Summon a 3/5 City guard", "worker", -85),
                     Creature(1, "Selfless Knight", 1, 2, "Desperate Give a friendly minion armored", "knight", -86),
