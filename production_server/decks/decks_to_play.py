...
bot_deck = [Creature(7, 'Templar Knight', 7, 5, "Guard", 3323),
            # Creature(1, 'Page', 1, 1, "Draw a card", 13324),
            # Creature(1, 'Page', 1, 1, "Draw a card", 3324),
            Creature(2, 'Squire', 3, 2, "", 3325),
            Creature(2, 'Squire', 3, 2, "", 13325),
            ...
            # Creature(6, 'Teutonic Knight', 6, 6, "", 3332),
            # Creature(6, 'Teutonic Knight', 6, 6, "", 13332),
            ...
            Item(1, "Leather Armor", "Give a creature +0/+2", 474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 1474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 2474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 3474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 4474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 5474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 7474789),
            Item(1, "Leather Armor", "Give a creature +0/+2", 6474789),
            # Item(1, "Cloth Armor", "Give a creature +0/+1 and Charge", 957106),
            # Item(2, "Plate Armor", "Give a creature +0/+4", 1650267),
            Item(1, "Dagger", "Give a creature +1/+0", 1876590)
            ]
demo_deck = [Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", 1),
             Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", 2),
             Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", 3),
             Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", 4),
             Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", 5),
             Creature(1, 'Page', 1, 1, "Draw a card", 6),
             Creature(1, 'Page', 1, 1, "Draw a card", 7),
             Creature(1, 'Page', 1, 1, "Draw a card", 8),
             Creature(1, 'Page', 1, 1, "Draw a card", 9),
             Creature(1, 'Page', 1, 1, "Draw a card", 10),
             Creature(1, 'Page', 1, 1, "Draw a card", 11),
             Creature(1, 'Page', 1, 1, "Draw a card", 12),
             Creature(1, 'Page', 1, 1, "Draw a card", 13),
             Creature(1, 'Page', 1, 1, "Draw a card", 14),
             ]
test_deck = [Creature(1, 'Templar Knight', 5, 1, "Guard", 1123),
             Creature(1, 'Page', 1, 1, "Draw a card", 1124),
...
integration_deck_official = [Creature(7, 'Templar Knight', 5, 5, "Guard", 23),
                             Creature(1, 'Page', 1, 1, "Draw a card", 24),
                             Creature(1, 'Page', 1, 1, "Draw a card", 124),
                             ...
                             Creature(6, 'Teutonic Knight', 6, 6, "", 32),
                             Item(2, "Knight's Equipment", "Give a creature +2/+2", 43),
                             Item(2, "Knight's Equipment", "Give a creature +2/+2", 42),
                             Spell(1, "Personal Guard", "Give a soldier guard", 34),
                             Spell(1, "Personal Guard", "Give a soldier guard", 35),
                             Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 20),
                             Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 21),
                             Spell(3, "Volley", "Deal 2 damage to all enemies", 39),
                             Spell(3, "Volley", "Deal 2 damage to all enemies", 1139),
                             Spell(1, "Arrow shot", "Deal 2 damage to a enemy", 138),
                             Spell(1, "Arrow shot", "Deal 2 damage to a enemy", 139),
                             ...
                             Spell(1, "Bandage", "Heal a friendly soldier for 4", 55),
                             Spell(1, "Bandage", "Heal a friendly soldier for 4", 56),
                             Item(1, "Shield", "Give a creature +0/+2 and Guard", 45),
                             Item(1, "Shield", "Give a creature +0/+2 and Guard", 46),
                             Creature(2, "Guard Dog", 2, 2, "Guard", 77),
                             Creature(2, "Guard Dog", 2, 2, "Guard", 87),
                             ]
integration_deck_opponent = [Creature(1, 'Templar Knight', 5, 1, "Guard", 3323),
                             ...
                             Spell(1, "Volley", "Deal 2 damage to all enemies", 3341),
                             Spell(1, "Arrow shot", "Deal 2 damage to a enemy", 3340),
...
cards_that_are_in_the_game = [Creature(0, "Peasant", 1, 1, "", -1),
                              ...
                              Spell(1, "Personal Guard", "Give a soldier guard", -14),
                              ...
                              Item(1, "Leather Armor", "Give a creature +0/+2 and draw a card", -25),
                              Item(1, "Cloth Armor", "Give a creature +0/+1 and Charge", -26),
                              Item(2, "Plate Armor", "Give a creature +0/+4", -27),
                              Item(1, "Dagger", "Give a creature +1/+0", -28),
...
knights_orders = [Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 251),
                  ...
                  Creature(6, 'Teutonic Knight', 6, 6, "", 253),
                  Creature(6, 'Teutonic Knight', 6, 6, "", 254),
                  ...
                  Creature(2, 'Squire', 3, 2, "", 257),
                  Creature(2, 'Squire', 3, 2, "", 258),
                  Creature(1, 'Page', 1, 1, "Draw a card", 259),
                  Creature(1, 'Page', 1, 1, "Draw a card", 260),
