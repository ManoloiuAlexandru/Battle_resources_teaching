...
demo_deck = [
    ...
    Spell(0, "Animal Battle Companion", "Summon a random war animal", 5),
    Spell(0, "Animal Battle Companion", "Summon a random war animal", 6),
    Spell(0, "Animal Battle Companion", "Summon a random war animal", 7),
    Spell(0, "Warhammer", "Break an enemy armor making him lose all attributes", 0),
    Creature(0, "Voice of the emperor", 4, 3, "Set a minion attack and health to 3", "soldier", 3),
    Creature(0, "Bailiff", 3, 3, "Set a minion attack to 1", "soldier", 4)
]
