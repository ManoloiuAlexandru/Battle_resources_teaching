...
cards_that_are_in_the_game_for_all = [Creature(0, "Peasant", 1, 1, "", -1),
                                      ...
                                      Creature(8, "Richard the Lionheart", 7, 7,
                                               ...
                                               -21),
                                      Creature(2, "Miner", 2, 2, "At the end of your turn draw a card", -23),
...
cards_for_byzantine_empire = [
    ...
    Creature(6, "Cataphract", 6, 5, "Guard Armored", -39),
...
mongols_hordes = [Spell(3, "Volley", "Deal 2 damage to all enemies", 1900),
                  ...
                  Creature(1, "Wild Horse", 2, 1, "Draw a charge card", 1907),
                  ...
                  Creature(1, "Wild Horse", 2, 1, "Draw a charge card", 1921),
                  # Spell(2, "Call of the Khan", "Draw a card if it has Charge reduce the cost to 0", 1921),
                  Creature(3, "Hunter", 3, 2, "Summon a 1/1 Dog", 1922),
                  Creature(3, "Hunter", 3, 2, "Summon a 1/1 Dog", 1923),
...
defenders = [Creature(4, "Pronoiar", 3, 3, "Charge", 100),
             ...
             Creature(6, "Cataphract", 6, 5, "Guard Armored", 102),
             ...
             Creature(6, "Cataphract", 6, 5, "Guard Armored", 108),
             ...
             Creature(1, "Watchman", 2, 1, "Draw a guard card", 128),
             Creature(1, "Watchman", 2, 1, "Draw a guard card", 129),
             Creature(2, "Watchtower", 2, 0, "All your guards get +1/+2", 104),
             ]
