...
bot_deck = [Creature(7, 'Templar Knight', 5, 5, "Guard", 3323),
            ...
            Spell(6, "Bodyguards", "Summon  2 Guards from your deck", 786781),
            Spell(6, "Bodyguards", "Summon  2 Guards from your deck", 67861),
            ...
            Creature(9, "Frederick Barbarossa", 8, 8, "While Barbarossa is on the field enemy minions get -1/0",
                     99283),
            Creature(8, "Richard the Lionheart", 7, 7,
                     "While Richard the Lionheart is on the filed your minions get +1/+1", 98933),
            Item(3, "Leather Armor", "Give a creature +0/+2", 474789),
            Item(2, "Cloth Armor", "Give a creature +0/+1", 957106),
            Item(5, "Plate Armor", "Give a creature +0/+4", 1650267),
            Item(2, "Dagger", "Give a creature +1/+0", 1876590)
            ]
...
cards_that_are_in_the_game = [Creature(1, "Peasant", 1, 1, "", -1),
                              ...
                              Spell(6, "Bodyguards", "Summon  2 Guards from your deck", -22),
                              Creature(2, "Miner", 2, 2, "", -23),
                              Creature(5, "City Guard", 6, 3, "Guard", -24),
                              Item(3, "Leather Armor", "Give a creature +0/+2", -25),
                              Item(2, "Cloth Armor", "Give a creature +0/+1", -26),
                              Item(5, "Plate Armor", "Give a creature +0/+4", -27),
                              Item(2, "Dagger", "Give a creature +1/+0", -28)
                              ]
...
knights_orders = [Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 251),
                  ...
                  Spell(6, "Bodyguards", "Summon  2 Guards from your deck", 285),
                  Spell(6, "Bodyguards", "Summon  2 Guards from your deck", 286),
                  ]
