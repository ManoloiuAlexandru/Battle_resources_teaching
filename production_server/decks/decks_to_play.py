...
bot_deck = [Creature(1, 'Templar Knight', 5, 5, "Guard", 3323),
            ...
            Spell(1, "Kill", "Kill an enemy soldier", 3338),
            ...
            Spell(1, "Bandage", "Heal a friendly soldier for 4", 3357),
            Spell(1, "Bandage", "Heal a friendly soldier for 4", 3358),
            ]
demo_deck = [Item(1, "Knight's Equipment", "Give a creature +2/+2", 1),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 2),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 3),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 4),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 5),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 6),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 7)
             ]

test_deck = [Item(1, "Knight's Equipment", "Give a creature +2/+2", 8),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 9),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 10),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 11),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 12),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 13),
             Item(1, "Knight's Equipment", "Give a creature +2/+2", 14),
             ]
...
dict_of_decks = {"demo_deck": demo_deck, "bot_deck": bot_deck, "test_deck": test_deck,
                 ...
                 "knight_deck_official": knight_deck_official,
                 }
