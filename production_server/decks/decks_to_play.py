...
bot_deck = [Creature(7, 'Templar Knight', 7, 5, "Guard", 3323),
            ...
            Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 1),
            Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 2),
...
demo_deck = [
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 2),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 3),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 4),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 5),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 6),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 7),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 8),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 9),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 10),
    Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 11),
]
...
cards_that_are_in_the_game = [Creature(0, "Peasant", 1, 1, "", -1),
                              ...
                              Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", -31)
                              ]
