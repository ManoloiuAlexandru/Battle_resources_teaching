...
cards_for_mongol = [Spell(3, "Volley", "Deal 2 damage to all enemies", -5),
                    ...
                    Creature(3, "Negotiator", 1, 1, "Give your hand +1/+1 and draw a card", "worker", -57),
...
mongols_hordes = [Spell(3, "Volley", "Deal 2 damage to all enemies", 1900),
                  ...
                  Creature(3, "Negotiator", 1, 1, "Give your hand +1/+1 and draw a card", "worker", 1902),
                  ...
                  Creature(3, "Farmer", 1, 1, "Gain 1 mana crystal", "worker", 1908),
                  Creature(3, "Farmer", 1, 1, "Gain 1 mana crystal", "worker", 1909),
                  Spell(3, "Horse riding lessons", "Give a friendly creature charge and +2 attack",
                        1910),
                  Spell(3, "Horse riding lessons", "Give a friendly creature charge and +2 attack",
                        1911),
                  ...
                  Creature(2, "Guard Dog", 2, 2, "Guard", "animal", 1916),
                  Creature(3, "Negotiator", 1, 1, "Give your hand +1/+1 and draw a card", "worker", 1917),
                  ...
                  Creature(2, "Wild Horse", 2, 1, "Draw a charge card", "animal", 1922),
                  Spell(8, "War Pack", "Summon all war animals", 1923),
                  Creature(2, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", "worker", 1924),
                  Creature(2, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", "worker", 1925),
                  Creature(2, 'Squire', 2, 3, "", "knight", 1926),
...
power_of_the_people = [Creature(8, "Richard the Lionheart", 6, 6, "Draw a Spell and a Creature Guard", "knight", 911),
                       ...
                       Creature(2, 'Page', 1, 1, "Draw a card", "knight", 922),
                       Creature(3, "Priest", 1, 1,
                                "Restore a friendly minion to full HP and give it +1/+1", "worker",
                                923),
...
all_cards_in_game = [Creature(0, "Peasant", 1, 1, "", "worker", -1),
                     ...
                     Creature(1, "Church Scholar", 2, 1, "Evrey time a creature is healed gain +1/+1 ", "worker",
                              -34),
                     Spell(3, "Knight's training", "Give a minions +3/+3", -35),
                     Spell(6, "Peace Treaty", "Return all creature form the battlefield to their owners hands.", -36),
                     Creature(7, "Cataphract", 6, 6, "Guard Armored", "knight", -39),
