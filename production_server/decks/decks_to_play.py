...
bot_deck = [Creature(7, 'Templar Knight', 7, 5, "Guard", 3323),
            ...
            Creature(6, 'Teutonic Knight', 6, 5, "", 3332),
            Creature(6, 'Teutonic Knight', 6, 5, "", 13332),
            ...
            Creature(3, "Guard Dog", 2, 2, "Guard Charge", 989),
            Creature(3, "Guard Dog", 2, 2, "Guard Charge", 900),
            ...
            Creature(7, "Frederick Barbarossa", 8, 5, "While Barbarossa is on the field enemy minions get -1/0",
                     99283),
...
demo_deck = [Spell(1, "Feudal Obligations", "Draw 2 cards", 1),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 2),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 3),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 4),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 5),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 15),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 16),
             Spell(1, "Feudal Obligations", "Draw 2 cards", 17),
...
integration_deck_official = [Creature(7, 'Templar Knight', 5, 5, "Guard", 23),
                             ...
                             Creature(3, "Guard Dog", 2, 2, "Guard Charge", 77),
                             Creature(3, "Guard Dog", 2, 2, "Guard Charge", 87),
                             ]
...
cards_that_are_in_the_game = [Creature(0, "Peasant", 1, 1, "", -1),
                              ...
                              Creature(6, 'Teutonic Knight', 6, 5, "", -4),
                              ...
                              Creature(3, "Guard Dog", 2, 2, "Guard Charge", -18),
                              Spell(3, "Horse riding lessons", "Give a friendly soldier charge", -19),
                              Creature(7, "Frederick Barbarossa", 8, 5,
                                       "While Barbarossa is on the field enemy minions get -1/0", -20),
                              Creature(8, "Richard the Lionheart", 7, 7,
                                       "While Richard the Lionheart is on the filed your minions get +1/+1", -21),
                              Spell(8, "Bodyguards", "Summon  2 Guards from your deck", -22),
                              Creature(2, "Miner", 4, 1, "", -23),
                              Creature(5, "City Guard", 6, 3, "Guard", -24),
                              Item(1, "Leather Armor", "Give a creature +0/+2", -25),
