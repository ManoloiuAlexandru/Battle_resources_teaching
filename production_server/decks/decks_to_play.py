...
demo_deck = [
    Creature(0, "Andras", 99, 0, "Guard", 12),
    Creature(4, "Lost Noble", 1, 1, "Desperate Summon a 3/5 City guard", 0),
    Creature(4, "Lost Noble", 1, 1, "Desperate Summon a 3/5 City guard", 1)
]
