...
bot_deck = [Creature(7, 'Templar Knight', 5, 5, "Guard", 3323),
            Creature(0, 'Page', 1, 1, "", 13324),
            Creature(0, 'Page', 1, 1, "", 3324),
...
demo_deck = [Spell(1, "Bodyguards", "Summon  2 Guards from your deck", 1),
             Spell(1, "Bodyguards", "Summon  2 Guards from your deck", 3),
             Spell(1, "Bodyguards", "Summon  2 Guards from your deck", 2),
             Spell(1, "Bodyguards", "Summon  2 Guards from your deck", 4),
             Spell(1, "Bodyguards", "Summon  2 Guards from your deck", 5),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 6),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 7),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 8),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 9),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 10),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 11),
             Creature(7, 'Templar Knight', 7, 5, "Guard", 12),
             ]
test_deck = [Creature(1, 'Templar Knight', 5, 1, "Guard", 1123),
             Creature(0, 'Page', 1, 1, "", 1124),
...
knights_orders = [Creature(9, "Two-handed Knight", 5, 5, "Kill an enemy soldier", 251),
                  ...
                  Creature(0, 'Page', 1, 1, "", 259),
                  Creature(0, 'Page', 1, 1, "", 260),
