...
bot_deck = [Creature(7, 'Templar Knight', 7, 5, "Guard", 3323),
            ...
            Spell(1, "Personal Guard", "Give a soldier guard and draw a card", 53334),
            Spell(1, "Personal Guard", "Give a soldier guard and draw a card", 63334),
            Spell(1, "Personal Guard", "Give a soldier guard and draw a card", 73334),
            Spell(1, "Personal Guard", "Give a soldier guard and draw a card", 83334),
            Spell(1, "Personal Guard", "Give a soldier guard and draw a card", 3335),
