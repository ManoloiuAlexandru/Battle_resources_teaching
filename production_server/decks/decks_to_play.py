...
bot_deck = [Creature(7, 'Templar Knight', 7, 5, "Guard", 3323),
            ...
            Creature(3, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 7),
            Creature(3, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", 8),
            ...
            Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 4571),
            Creature(2, "Farmer", 1, 1, "Gain 1 mana crystal", 2885),
            ...
            Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 54578),
            Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 61290)
            ]
demo_deck = [
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 1),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 2),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 3),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 4),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 5),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 6),
    Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", 7),
    Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP and give it +1/+1",
             8),
    Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP and give it +1/+1",
             9),
    Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP and give it +1/+1",
...
cards_that_are_in_the_game = [Creature(0, "Peasant", 1, 1, "", -1),
                              ...
                              Creature(3, "Priest", 1, 1, "Restore a friendly soldier to full HP and give it +1/+1",
                                       -15),
                              ...
                              Creature(3, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", -33),
                              Creature(1, "Church Schooler", 1, 1, "Evrey time a creature is healed gain +1/+1 ", -34)
                              ]
...
dict_of_decks = {"demo_deck": demo_deck, "bot_deck": bot_deck, "knights_orders": knights_orders}
