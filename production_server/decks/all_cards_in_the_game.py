...
cards_that_are_in_the_game_for_all = [Creature(0, "Peasant", 1, 1, "", "worker", -1),
                                      ...
                                      Creature(2, "Lumberjack", 2, 2, "Give a friendly minion +1 attack", "worker",
                                               -33),
                                      Creature(1, "Church Scholar", 2, 1, "Every time a creature is healed gain +1/+1 ",
                                               "worker", -34),
                                      ...
                                      Creature(3, "Battle Tactician", 2, 2, "Cast a tactic from your deck", "worker",
                                               -238),
                                      Creature(2, "Novice Tactician", 3, 2, "If you control a Tactic draw a card",
                                               "worker", -239),
                                      Creature(2, "Knight Recruiter", 3, 1, "If you hold a knight discover a knight",
                                               "worker", -240),
                                      Creature(4, "Sir William Marshal", 4, 5,
                                               "Reduce the Cost by 2 of all knights in your deck",
                                               "knight", -267),
                                      Creature(4, "Veteran Knight", 4, 4,
                                               "Reduce the cost of your knights in your hand and give them +1/+1",
                                               "knight",
                                               -268),
                                      Creature(20, "Catapult", 8, 8,
                                               "Cost 1 less for each mana you spent on spells this game", "machine",
                                               -270),
                                      ...
                                      Creature(2, "Enthusiastic Archer", 3, 2,
                                               ...
                                               -291),
                                      Creature(3, "Wandering Bard", 3, 2,
                                               "Draw a card. If it's a spell, reduce its cost by 1", "worker",
                                               -295),
                                      Creature(5, "Baldwin of Antioch", 4, 6,
                                               "Change your kingdom power with a better one", "knight", -315),
                                      Creature(1, "Tax collector", 1, 1,
                                               "Whenever you summon a creature heal the empire for 1",
                                               "worker", -322),
                                      Creature(1, "Armored Librarian", 1, 1,
                                               "When you cast a spell on this get +1/+1 and armored",
                                               "soldier", -319),
                                      Creature(1, "Last Empire Believer", 23, 23,
                                               "Gains -X/-X, where X is your kingdoms health",
                                               "soldier", -326),
                                      Creature(2, "Empire Believer", 2, 2, "Whenever you get life this gets +1/+1",
                                               "soldier", -333),
                                      Creature(2, "Church Story Teller", 2, 1,
                                               "Whenever a creature gets buffed by a spell draw a card and heal for 1",
                                               "worker", -334),
                                      Creature(6, "Knight of the Coin", 6, 6, "Whenever this attacks draw 2 cards Rush",
                                               "knight", -335),
...
all_cards_in_game = [Creature(0, "Peasant", 1, 1, "", "worker", -1),
                     ...
                     Creature(2, "Novice Tactician", 3, 2, "If you control a Tactic draw a card", "worker", -239),
                     Creature(2, "Knight Recruiter", 3, 1, "If you hold a knight discover a knight", "worker", -240),
                     ...
                     Spell(1, "Get back to work",
                           ...
                           -247),
                     Creature(5, "Ephix Maximus", 6, 6, "Charge Give all your cards Charge and +2 attack", "legend",
                              -248),
                     Creature(5, "Lndrau Aaurentis", 8, 8, "Armored Guard All your cards get guard", "legend",
                              -249),
                     ...
                     Spell(1, "Imperial Drama",
                           ...
                           -265),
                     Creature(5, "Lenxaadra, Queen of Drama", 5, 5,
                              "Silence all enemy minions from deck,hand and battlefield",
                              "legend", -266),
                     Creature(4, "Sir William Marshal", 4, 5, "Reduce the Cost by 2 of all knights in your deck",
                              "knight", -267),
                     Creature(4, "Veteran Knight", 4, 4,
                              "Reduce the cost of your knights in your hand and give them +1/+1",
                              "knight",
                     ...
                     Creature(20, "Catapult", 8, 8, "Cost 1 less for each mana you spent on spells this game",
                              "machine", -270),
                     Creature(2, "Soldier Motivator", 2, 1, "Reduce the cost of your soldiers in your hand by 1",
                              "soldier", -271),
                     ...
                     Creature(5, "Henry III", 5, 5,
                              ...
                              -314),
                     Creature(5, "Baldwin of Antioch", 4, 6, "Change your kingdom power with a better one", "knight",
                              -315),
                     ...
                     Creature(2, "Tolui", 3, 2, "After you cast a spell, deal equal to its Cost to the enemy Hero.",
                              "soldier", -318),
                     Creature(1, "Armored Librarian", 1, 1, "When you cast a spell on this get +1/+1 and armored",
                              "soldier", -319),
                     ...
                     Spell(2, "Will of God", "Give a creature +1/+1 and it can't be blocked", -325),
                     ...
                     Creature(1, "Cow", 3, 0, "Desperate Heal your empire for 1 and draw a card. Guard", "animal",
                              -329),
                     ...
                     Spell(1, "I want actions not words",
                           ...
                           -331),
                     Creature(5, "Lerima,Persistent One", 10, 10,
                              "Charge Desperate return this to your hand",
                              "legend", -332),
                     Creature(2, "Empire Believer", 2, 2, "Whenever you get life this gets +1/+1", "soldier", -333),
                     Creature(2, "Church Story Teller", 2, 1,
                              "Whenever a creature gets buffed by a spell draw a card and heal for 1",
                              "worker", -334),
                     Creature(6, "Knight of the Coin", 6, 6, "Whenever this attacks draw 2 cards Rush", "knight", -335),
                     ]
