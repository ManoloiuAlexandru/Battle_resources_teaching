...
test_deck = [Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP", 1),
             Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP", 2),
             Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP", 3),
             Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP", 4),
             Creature(1, "Priest", 1, 1, "Restore a friendly soldier to full HP", 5),
...
integration_deck = [Creature(1, 'Templar Knight', 5, 1, "Guard", 23),
                    ...
                    Spell(1, "Personal Guard", "Give a soldier guard", 48),
                    Spell(1, "Personal Guard", "Give a soldier guard", 47),
                    Spell(1, "Personal Guard", "Give a soldier guard", 46),
                    Spell(1, "Personal Guard", "Give a soldier guard", 45),
...
integration_deck_opponent = [Creature(1, 'Templar Knight', 5, 1, "Guard", 3323),
                             ...
                             Spell(1, "Personal Guard", "Give a soldier guard", 3344),
                             Spell(1, "Personal Guard", "Give a soldier guard", 3345),
